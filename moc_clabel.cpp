...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CLabel_t, stringdata) + ofs \
...
void CLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CLabel::MouseClick)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_CLabel.data,
      qt_meta_data_CLabel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CLabel.stringdata))
        return static_cast<void*>(const_cast< CLabel*>(this));
