...
//                painter.setBrush(c2);
            ...
            else if(style_back == esColor)
            {
                painter.setBrush(init_struct.color_backgraund);
                painter.drawRect(rect_no_check);
            }
        }
       ...
       //QColor col = (buttons[i].state == esChecked)? init_struct.color_text_checked : init_struct.color_text;
//        col.setAlpha(150);
        qf.setBold(false);
        painter.setFont(qf);
        painter.setPen(QPen((buttons[i].state == esChecked)? init_struct.color_text_checked : init_struct.color_text));
